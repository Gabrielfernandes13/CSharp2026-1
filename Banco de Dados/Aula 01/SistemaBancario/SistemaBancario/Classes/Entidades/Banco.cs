namespace SistemaBancario.Classes.Entidades
{
    ...
    internal class Banco
    {
        ...
        ///<summary>
        ///Realiza um saque na conta, diminuindo o saldo da conta.
        ///Cobra automaticamente uma taxa de R$ 5,00 por operação de saque.
        ...
        public void Saque(double valor)
        {
            ...
            Console.WriteLine($"Saque de {valor:C} realizado com sucesso. Taxa de {taxaSaque:C} aplicada. Saldo atual: {Saldo:C}");
        }
    }
}
